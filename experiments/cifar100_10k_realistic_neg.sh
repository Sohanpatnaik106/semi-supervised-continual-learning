...
###############################################################
# save directory
OUTDIR=outputs-temp/CIFAR100-10k/realistic-neg
MAXTASK=-1
...
# dm
python3 -u run_sscl.py --dataset CIFAR100 --l_dist $L_DIST --train_aug --rand_split --gpuid $GPUID --repeat $REPEAT --labeled_samples 10000 --unlabeled_task_samples -1 --ul_dist $UL_DIST  \
