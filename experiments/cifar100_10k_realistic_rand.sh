...
python -u run_sscl.py --dataset CIFAR100 --l_dist $L_DIST --train_aug --rand_split --gpuid $GPUID --repeat $REPEAT --labeled_samples 10000 --unlabeled_task_samples -1 --ul_dist $UL_DIST  \
    ...
    --max_task $MAXTASK --log_dir ${OUTDIR}/dm/no_warmup --dynamic_threshold True --fm_thresh 0.95 --fm_epsilon 0.000001 --threshold_warmup False --non_linear_mapping False
...
#     --memory $MEMORY --model_name $MODELNAME --ood_model_name $MODELNAMEOOD_DC --model_type resnet --DW --FT  \
#     --tpr $TPR --oodtpr $TPR_OOD \
#     --max_task $MAXTASK --log_dir ${OUTDIR}/dm/warmup --dynamic_threshold False --fm_thresh 0.95 --fm_epsilon 0.000001 --threshold_warmup True --non_linear_mapping False
